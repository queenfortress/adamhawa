...
export default async (req, res) => {
    ...
    try {
        ...
        console.log('[' + operationTime + '][API-GET-Products-By-Gudang] Gudang')
        console.log(reqParams[0])
        console.log('[' + operationTime + '][API-GET-Products-By-Gudang] Page')
        ...
        console.log('[' + operationTime + '][API-GET-Products-By-Gudang] Fetched products')
